          ...
          <div>
            <section>
              ...
              >
                ...
                {this.props.status ? (
                  <img className="chev" src="https://s3-us-west-1.amazonaws.com/housing-hr/down.png" alt="" />
                ) : (
                  <img className="chev" src="https://s3-us-west-1.amazonaws.com/housing-hr/up.png" alt="" />
                )}
              </h2>
              {this.props.status && (
